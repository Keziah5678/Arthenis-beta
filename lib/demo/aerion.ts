...
export const AERION_WORLD: DemoWorld = {
  ...
  visual_bible: { theme: "Fantasy", magic: true, fiction: true, fictionalCreatures: true, coverImageUrl: "/art/cover.jpg", mapImageUrl: "/art/map.jpg" },
...
export const AERION_ITEMS: DemoItem[] = [
  ...
  { id: "demo-p1", kind: "Personnage", name: "Elarion Duskblade", description: "Chevalier-mage de Valcendre, l'un des rares autorisés à pratiquer la magie de combat. Envoyé enquêter sur les Pics de Givre.", day: 5, x: 10, y: 34, imageUrl: "/art/portrait.jpg" },
