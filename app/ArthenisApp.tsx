...
const themeVisual=(theme:string,description:string="")=>{const t=(theme+" "+description).toLowerCase();if(/post-apo|sombre|dark|effondr/.test(t))return "volcano";if(/science|futur|cyber|tour-cit/.test(t))return "city";if(/glace|arctique|nord|neige/.test(t))return "ice";if(/désert|desert|sable/.test(t))return "desert";if(/océan|ocean|marine|île|ile/.test(t))return "ocean";return "forest";};
...
export default function ArthenisApp(){
 ...
 const geoItems=items.filter(i=>i.kind==="Région"||i.kind==="Civilisation"||i.kind==="Village");
