...
function EntityVisual({item}:{item:Item}){if(item.imageUrl)return <img className="worldTile" src={item.imageUrl} alt=""/>;return <Tile kind={visual(item)} seed={item.id+item.name}/>}
